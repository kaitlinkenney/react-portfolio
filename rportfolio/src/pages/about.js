...
function About() {
    return (
        ...
        <div>
            ...
            <h1 style={{ color: "white" }}> Skills Overview </h1>
            ...
            throughout school. I am a full stack web developer who likes to problem solve. I hope to continuously build on my knowledge and
                skill set. </p>
            <p style={{ color: "white" }}> <a href="https://docs.google.com/document/d/1wnHaEFWsO2BqsGK51IQHHZROhXPmVo6s2M1gN6VSUFE/edit"> View my resume here!</a>
            </p>
            <div className="row">
            <div className="card ml-12" style={{width: "370px"}}>
